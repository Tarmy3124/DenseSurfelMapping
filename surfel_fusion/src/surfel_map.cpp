...
void SurfelMap::image_input(const sensor_msgs::CompressedImageConstPtr &image_input)
{
    if(surfel_state){
...
//        printf("receive color!\n");
        ...
        cv_bridge::CvImagePtr image_ptr = cv_bridge::toCvCopy(image_input, sensor_msgs::image_encodings::RGB8);
        cv::Mat image = image_ptr->image;
        ros::Time stamp = image_ptr->header.stamp;
...
int cnt = 0;
//t1_depth
// subscribe compressed depth
void SurfelMap::depthCb(const sensor_msgs::ImageConstPtr& depth_input,
 ...
 if(surfel_state){
        ...
        if(cnt % 3 == 0)*/
        {
            ...
            std::cout<<"depth_input->encoding"<<depth_input->encoding<<std::endl;
